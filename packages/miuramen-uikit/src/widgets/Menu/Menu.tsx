...
import MiuRamenPrice from "../../components/MiuRamenPrice/MiuRamenPrice";
    ...
    <Wrapper>
      <StyledNav showMenu={showMenu}>
        ...
        <Flex alignItems="center">
          {!isMobile && (
            <Box mr="12px">
              <MiuRamenPrice miuramenPriceUsd={miuramenPriceUsd} />
            </Box>
          )}
          <Box mt="4px">
            <LangSelector
      ...
      <BodyWrapper mt={!subLinks ? `${MENU_HEIGHT + 1}px` : "0"}>
        <Inner isPushed={false} showMenu={showMenu}>
          ...
          <Footer
            ...
            setLang={setLang}
            currentLang={currentLang}
            miuramenPriceUsd={miuramenPriceUsd}
            buyMiuRamenLabel={buyMiuRamenLabel}
