...
const defaultProps = {
  ...
  setLang: noop,
  currentLang: "EN",
  miuramenPriceUsd: 0.023158668932877668,
  links,
  subLinks: links[0].items,
  footerLinks,
  profile: null,
  userMenu: <UserMenuComponent account="0xd03ea8624C8C5987235048901fB614fDcA89b117" />,
  globalMenu: <GlobalMenuComponent />,
  activeItem: "/swap",
  activeSubItem: "https://exchange.miuramenswap.finance",
  buyMiuRamenLabel: "Buy MIUX",
};
  ...
  return (
    <MemoryRouter initialEntries={["/teams"]}>
      <Menu
        ...
        setLang={noop}
        currentLang="EN"
        miuramenPriceUsd={0.23158668932877668}
        links={links}
        subLinks={subLinks}
        footerLinks={footerLinks}
      >
