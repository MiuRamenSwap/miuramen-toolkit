...
import currentMiuRamenswapDefaultList from "../lists/miuramenswap-default.json";
import currentMiuRamenswapExtendedtList from "../lists/miuramenswap-extended.json";
import currentMiuRamenswapTop15List from "../lists/miuramenswap-top-15.json";
import currentMiuRamenswapTop100tList from "../lists/miuramenswap-top-100.json";
import { buildList, VersionBump } from "../src/buildList";

const currentLists = {
  "miuramenswap-default": currentMiuRamenswapDefaultList,
  "miuramenswap-extended": currentMiuRamenswapExtendedtList,
  "miuramenswap-top-100": currentMiuRamenswapTop100tList,
  "miuramenswap-top-15": currentMiuRamenswapTop15List,
};
...
expect.extend({
  ...
  toBeValidLogo(token) {
    ...
    const refersToLocalLogo = token.logoURI === `https://tokens.miuramenswap.finance/images/${token.address}.png`;
...
describe.each([["miuramenswap-default"], ["miuramenswap-extended"], ["miuramenswap-top-100"], ["miuramenswap-top-15"]])(
  "buildList %s",
  (listName) => {
