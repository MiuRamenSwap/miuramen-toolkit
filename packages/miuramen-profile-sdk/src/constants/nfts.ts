...
const Nfts: Nft[] = [
  ...
  {
    name: "MiuRamenston Easter '21",
    description: "Melting Easter eggs and melting hearts!",
    images: {
      lg: "miuramenston-easter-21-lg.png",
      md: "miuramenston-easter-21-md.png",
      sm: "miuramenston-easter-21-sm.png",
      ipfs: `${IPFS_GATEWAY}/ipfs/QmZGqWaovULNEMKxBCGnGjh27JQkAyadS6AW4J4Lzf3XBp/easter-miuramenr.png`,
    },
    sortOrder: 999,
    identifier: "easter-miuramenr",
    type: NftType.MIUX,
    variationId: 15,
  },
  {
  ...
  {
    name: "Sunny",
    description: "Sunny is always cheerful when there are miuramens around. Smile!",
    images: {
      lg: "sunny-lg.png",
      md: "sunny-md.png",
      sm: "sunny-sm.png",
  ...
  {
    name: "Churro",
    description: "Don't let that dopey smile deceive you... Churro's a master MIUX chef!",
    images: {
      lg: "churro-lg.png",
      md: "churro-md.png",
      sm: "churro-sm.png",
  ...
  {
    name: "Dollop",
    description: "Nommm... Oh hi, I'm just meditating on the meaning of MIUX.",
    images: {
      lg: "dollop-lg.png",
      md: "dollop-md.png",
      sm: "dollop-sm.png",
  ...
  {
    name: "Twinkle",
    description: "Three guesses what's put that twinkle in those eyes! (Hint: it's MIUX)",
    images: {
      lg: "twinkle-lg.png",
      md: "twinkle-md.png",
      sm: "twinkle-sm.png",
  ...
  {
    name: "Blueberries",
    description: "These bunnies like their miuramens with blueberries. What's your favorite topping?",
    images: {
  ...
  {
    name: "Circular",
    description: "Love makes the world go 'round... but so do miuramens. And these bunnies know it.",
    images: {
      lg: "circular-lg.png",
      md: "circular-md.png",
      sm: "circular-sm.png",
  ...
  {
    name: "Sparkle",
    description: "It’s sparkling syrup, miuramens, and even lottery tickets! This bunny really loves it.",
    images: {
      lg: "sparkle-lg.png",
      md: "sparkle-md.png",
      sm: "sparkle-sm.png",
