...
import MiuRamenProfileSdk from "./profile-sdk";
...
describe("MiuRamenProfileSdk", () => {
  describe("constructor", () => {
    ...
    it("uses custom provider instance if specified", () => {
      ...
      const sdk = new MiuRamenProfileSdk({ provider: customProvider });
      expect(sdk.provider).toBe(customProvider);
    });
    it("uses specific chainId if chainId is provided", () => {
      const sdk = new MiuRamenProfileSdk({ chainId: TESTNET_CHAIN_ID });
    ...
    describe("getProfile", () => {
      ...
      it("sets cookies", async () => {
        ...
        expect(Cookies.set).toBeCalledWith(
          ...
          {
            username: "Cheems",
            avatar: `https://miuramenswap.finance/images/nfts/${sleepyNft.images.sm}`,
          },
