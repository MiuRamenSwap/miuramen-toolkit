...
import chaoticMiuRamenrsSm from "./teams/chaotic-miuramenrs-sm.png";
import chaoticMiuRamenrsMd from "./teams/chaotic-miuramenrs-md.png";
import chaoticMiuRamenrsLg from "./teams/chaotic-miuramenrs-lg.png";
import chaoticMiuRamenrsAlt from "./teams/chaotic-miuramenrs-alt.png";
import chaoticMiuRamenrsBg from "./teams/chaotic-miuramenrs-bg.svg";
...
const teamImages: ImageMap = {
  ...
  "chaotic-miuramenrs-sm.png": chaoticMiuRamenrsSm,
  "chaotic-miuramenrs-md.png": chaoticMiuRamenrsMd,
  "chaotic-miuramenrs-lg.png": chaoticMiuRamenrsLg,
  "chaotic-miuramenrs-alt.png": chaoticMiuRamenrsAlt,
  "chaotic-miuramenrs-bg.svg": chaoticMiuRamenrsBg,
};
