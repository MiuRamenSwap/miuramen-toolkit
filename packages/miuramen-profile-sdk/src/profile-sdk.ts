...
class MiuRamenProfileSdk {
   ...
   * API repo - https://github.com/miuramenswap/miuramen-profile-api
   */
   ...
   * Contract repo - https://github.com/miuramenswap/miuramen-contracts/tree/master/projects/profile-nft-gamification
   */
   ...
   * from MiuRamenProfile contract.
   * NFT's bunnyId is retrieved from MiuRamenBunnies contract and mapped to static NFT data stored in constant.
   * Contracts repo - https://github.com/miuramenswap/miuramen-contracts/tree/master/projects/profile-nft-gamification
   */
  getProfile = async (address: string): Promise<GetProfileResponse> => {
    try {
      ...
      if (isActive) {
        ...
        const avatar = nft ? `https://miuramenswap.finance/images/nfts/${nft.images.sm}` : undefined;
        ...
        Cookies.set(
          ...
          { domain: "miuramenswap.finance", secure: true, expires: 30 }
        );
      }
...
export default MiuRamenProfileSdk;
